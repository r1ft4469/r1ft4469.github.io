...
trailer_choice, imdb_keywords_choice, media_extra_info, genres_choice = dialogs.trailer_choice, dialogs.imdb_keywords_choice, dialogs.media_extra_info, dialogs.genres_choice
random_choice, options_menu, extras_menu, imdb_videos_choice = dialogs.random_choice, dialogs.options_menu, dialogs.extras_menu, dialogs.imdb_videos_choice
		...
		if controlID in button_ids:
			if controlID == playbrowse_id:
				...
				if self.media_type == 'movie':
					...
					return person_data_dialog({'query': director})
				else:
				...
				return options_menu(params, self.meta)
