...
def routing():
	...
	if 'navigator.' in mode:
		...
		elif mode == 'results_format_choice': dialogs.results_format_choice()
		...
		elif mode == 'clear_favorites_choice': dialogs.clear_favorites_choice()
		elif mode == 'audio_filters_choice': dialogs.audio_filters_choice()
	elif 'trakt.' in mode:
		if '.list' in mode:
